        ...
        <div>
          <div className={schedule.form_spacer}>
            ...
            <input
              ...
              value={form.title}
              type="text"
              placeholder="Add a title for your schedule"
            />
          </div>
          <div className={schedule.form_spacer}>
            ...
            <input
              ...
              type="text"
              placeholder="Give a brief description of your schedule"
            />
          </div>
          <div className={schedule.form_spacer}>
          ...
          <div className={schedule.form_spacer}>
            ...
            <input
              ...
              type="number"
              placeholder="set the time required (in minutes)"
            />
